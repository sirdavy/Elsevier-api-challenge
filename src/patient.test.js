  ...
  describe("constructor", () => {
    ...
    it("should throw an error if zipcode format invalid", () => {
      ...
      try {
        ...
        expect(error).toEqual(
          new Error("Invalid zip code format. Please use a 5-digit code")
        );
      }
    });
    ...
    it("should throw list of multiple errors", () => {
      const invalidPatientData = {
        birthDate: "24th March 1981",
        zipCode: "E12ND",
        admissionDate: "5-11-2020",
      ...
      try {
        ...
        expect(error).toEqual(
          new Error(
            "Invalid birthdate format. Please use the format yyyy-mm-dd; Invalid zip code format. Please use a 5-digit code; Invalid admission date format. Please use the format yyyy-mm-dd; Invalid discharge date format. Please use the format yyyy-mm-dd"
          )
        );
      }
    });
